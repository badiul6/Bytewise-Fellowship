    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Icon(Icons.lightbulb_outline, size: 400,
            color: _on?Colors.yellow:const Color.fromARGB(179, 228, 226, 226),
            shadows: _on?[
              const Shadow(color: Color.fromARGB(255, 240, 225, 86), blurRadius: 10)
            ]:null,),
            ...
            GestureDetector(
              ...
              child: Container(height: 140,width: 90, 
